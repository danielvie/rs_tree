...
// cargo run
//    Compiling rs_tree v0.1.0 (/Users/danielvieira/Sandbox/RUST/rs_tree)
// warning: associated function `find_child` is never used
//   --> src/main.rs:53:8
//    |
// 53 |     fn find_child(&self, value: &str) -> Option<&Box<Node>> {
//    |        ^^^^^^^^^^
//    |
//    = note: `#[warn(dead_code)]` on by default

// warning: associated function `insert_child` is never used
//   --> src/main.rs:57:8
//    |
// 57 |     fn insert_child(&mut self, value: String) {
//    |        ^^^^^^^^^^^^

// warning: `rs_tree` (bin "rs_tree") generated 2 warnings
